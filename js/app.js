            ...
            <div class="card h-100">
                ...
                <div class="card-footer text-center">
                  <div class="d-flex flex-column flex-md-row justify-content-between">
                    <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="btn btn-outline-primary fw-bold mb-2">Add to cart</button>
                    <button id="details-btn" class="btn btn-outline-info fw-bold mb-2">Details</button>
                  </div>
                </div>
            </div>     
        `;
